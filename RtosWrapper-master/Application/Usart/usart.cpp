...
void Usart::TransferData()
{
  ...
  std::cout << "Temp: " << to_string_with_precision(temperature, 2) << " C" << std::endl;
    std::cout << "Press: " << to_string_with_precision(pressure, 2) << " hPa" << std::endl;
    std::cout << "Humidity: " << to_string_with_precision(humidity, 2) << " %" << std::endl;
    std::cout << "DewPoint: " << to_string_with_precision(dewPoint, 2) << " C" << std::endl;
